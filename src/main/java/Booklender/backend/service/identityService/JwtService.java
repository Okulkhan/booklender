...
public class JwtService {
    ...
    public String generateToken(CustomUserDetails user){
        ...
        return createToken(new HashMap<>(),user.getEmail(), String.valueOf(user.getId()), JWT_EXPIRATION);
    }
    ...
    public String generateRefreshToken(CustomUserDetails user) {
        return createToken(new HashMap<>(),user.getEmail(),  String.valueOf(user.getId()), REFRESH_TOKEN_EXPIRATION);
    }
